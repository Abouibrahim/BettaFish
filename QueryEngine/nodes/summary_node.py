...
try:
    ...
    logger.warning("Warning: Cannot import forum_reader module, will skip HOST speech reading functionality")
...
class FirstSummaryNode(StateMutationNode):
    ...
    def run(self, input_data: Any, **kwargs) -> str:
        ...
        try:
            ...
            # If there's HOST speech, add it to the front of message as reference
        ...
        try:
            ...
            try:
                ...
                if fixed_json:
                    ...
                    logger.error("Cannot fix JSON, using cleaned text directly")
                    # If not JSON format, return cleaned text directly
                    return cleaned_output
    ...
    def mutate_state(self, input_data: Any, state: State, paragraph_index: int, **kwargs) -> State:
        ...
        try:
            ...
            if 0 <= paragraph_index < len(state.paragraphs):
                ...
                logger.info(f"Updated first summary of paragraph {paragraph_index}")
            else:
    ...
    def mutate_state(self, input_data: Any, state: State, paragraph_index: int, **kwargs) -> State:
        ...
        try:
            ...
            if 0 <= paragraph_index < len(state.paragraphs):
                ...
                logger.info(f"Updated reflection summary of paragraph {paragraph_index}")
            else:
                raise ValueError(f"Paragraph index {paragraph_index} out of range")
