...
class Qwen3EmbeddingUniversal(BaseQwenModel):
    ...
    def train(self, train_data: List[Tuple[str, int]], **kwargs) -> None:
        """Train model"""
        print(f"Starting to train Qwen3-Embedding-{self.model_size} model...")
...
def main():
    ...
    if not args.model_size:
        ...
        print("  1. 0.6B - Lightweight, fast training, memory requirement ~4GB")
        print("  2. 4B  - Medium scale, balanced performance, memory requirement ~16GB")
        print("  3. 8B  - Large scale, best performance, memory requirement ~32GB")
