"""
Generic Database Utility (Asynchronous)

This module provides database access wrapper based on SQLAlchemy 2.x async engine, supporting MySQL and PostgreSQL.
...
def _build_database_url() -> str:
    ...
    if os.getenv("DATABASE_URL"):
        return os.getenv("DATABASE_URL")  # Directly use externally provided complete URL
