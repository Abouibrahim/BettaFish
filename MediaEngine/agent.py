...
class DeepSearchAgent:
    ...
    def __init__(self, config: Optional[Settings] = None):
        ...
        Args:
            config: Configuration object, auto-loads if not provided
        """
        ...
        logger.info(f"Search toolkit: BochaMultimodalSearch (supports 5 multimodal search tools)")
    ...
    def execute_search_tool(self, tool_name: str, query: str, **kwargs) -> BochaResponse:
        ...
        Args:
            tool_name: Tool name, options:
                - "comprehensive_search": Comprehensive integrated search (default)
    ...
    def _initial_search_and_summary(self, paragraph_index: int):
        ...
        # Handle special parameters (new toolkit doesn't require date parameter handling)
        search_kwargs = {}
        ...
        if search_response and search_response.webpages:
            # Each search tool has specific result count, here we limit to 10
