...
Responsible for formatting final research results into well-formatted Markdown reports
"""
    ...
    def run(self, input_data: Any, **kwargs) -> str:
        ...
        try:
            if not self.validate_input(input_data):
                raise ValueError("Input data format error, requires list with title and paragraph_latest_state")
            ...
            # Call LLM to generate Markdown format (streaming, safely concatenate UTF-8)
        ...
        try:
            ...
            if len(paragraphs_data) > 1:
                report_lines.extend([
                    ...
                    "The above content provides important reference for understanding this topic.",
                    ""
                ])
