...
Provides a friendly Web interface for Query Agent
"""
...
def main():
    ...
    st.markdown("AI Agent with Strong Web Search Capabilities")
    st.markdown("Extensively crawling official reports and news, focusing on combining domestic and international resources to understand public opinion")
    ...
    if start_research:
        ...
        # Check related API key since DeepSeek is enforced
