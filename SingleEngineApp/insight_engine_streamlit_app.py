...
Provides a friendly Web interface for Insight Agent
"""
...
def main():
    ...
    st.markdown("Deep Analysis AI Agent for Private Opinion Database")
    st.markdown("24-hour automated crawling of opinion data from 13 social media platforms and tech forums including Weibo, Zhihu, GitHub, Coolapk, etc.")
    ...
    if start_research:
        ...
        # Automatically use API key and database config from configuration file
        ...
        # Create Settings configuration (fields must be uppercase to match Settings class)
        config = Settings(
