...
def main():
    ...
    st.markdown("AI Agent with Strong Multimodal Capabilities")
    st.markdown("Breaking through traditional text communication limits, extensively browsing videos, images, and live streams from Douyin, Kuaishou, and Xiaohongshu")
    st.markdown("Further enhanced capabilities using multimodal structured information from modern search engines such as calendar cards, weather cards, stock cards, etc.")
    ...
    # If auto query exists, use it as default, otherwise display placeholder
    ...
    if start_research:
        ...
        # Check related API key since Gemini is enforced
        ...
        # Automatically use API key from configuration file
...
def display_results(agent: DeepSearchAgent, final_report: str):
    ...
    tab1, tab2 = st.tabs(["Research Summary", "Citations"])
